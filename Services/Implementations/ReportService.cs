...
namespace SalesforceIntegrationApp.Services.Implementations
{
    public class ReportService : IReportService
    {
        ...
        private readonly string accessToken = "00D90000000uBr5!AQsAQAV2bayY1EilT9GdL8vGHRpWwXPrn5hK8Pw.Ms5HZoVAlAQexxEk9nJ7IRokKfggaQZIQ5jc5.N_c2XeFqvmxMq1lwXA";
        ...
        private ReportDataModel ParseReportJson(string json)
        {
            ...
            var columns = Enumerable.Range(1, dataRows[0].Count)
                                    .Select(i => $"Column{i}")
                                    .ToList();
